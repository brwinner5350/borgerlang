...
GenericValue CodeGenContext::runCode() {
	...
	GenericValue v = ee->runFunction(entry, noargs);
...
Value* NIdentifier::codeGen(CodeGenContext& context)
{
	...
	return new LoadInst(Type::getInt32Ty(GlobalContext), context.locals()[name], "", context.currentBlock());
}
...
Value* NReturnStatement::codeGen(CodeGenContext& context)
{
	...
	context.setCurrentRetval(returnValue);
	return returnValue;
}
...
Value* NFunctionDeclaration::codeGen(CodeGenContext& context)
{
	...
	ReturnInst::Create(GlobalContext, context.getCurrentRetval(), bblock);
